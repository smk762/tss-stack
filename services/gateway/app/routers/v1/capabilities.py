    ...
    return {
        ...
        "tts": {
            ...
            "controls": {
                ...
                "emphasis_strength": {"min": 0.0, "max": 1.0, "default": 0.5, "step": 0.05, "enabled": False},
                ...
                "sentence_split_aggressiveness": {"min": 0.0, "max": 1.0, "default": 0.5, "step": 0.05, "enabled": False},
                "punctuation_weight": {"min": 0.0, "max": 1.0, "default": 0.7, "step": 0.05, "enabled": False},
                "repeat_emphasis": {"min": 0.0, "max": 1.0, "default": 0.4, "step": 0.05, "enabled": False},
                "latency_mode": {"options": ["quality", "balanced", "realtime"], "default": "balanced", "enabled": False},
                "stream_chunk_ms": {"min": 40, "max": 400, "default": 120, "step": 20, "enabled": False},
